<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Suppliers.aspx.cs" Inherits="threetierwithweb.WebForm4" %>
...
<body>
    <form id="form4" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="SUPPLIER TABLE"></asp:Label>
        </div>
        <p>
