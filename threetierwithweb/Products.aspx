<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="threetierwithweb.WebForm2" %>
...
<body>
    <form id="form2" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="PRODUCT TABLE"></asp:Label>
        </div>
        <p>
